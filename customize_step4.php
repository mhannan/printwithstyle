...
<div class="body_internal_wrapper">
	<div class="process_step_wrapp">
		<img src="<?php echo ($row['cat_id'] == '4' || $row['cat_id'] == '5' || $row['cat_id'] == '6' ? siteURL.'images/mailing_1__no-env.png' : siteURL.'images/mailing_1.png');?>" />
	</div>
	<!--detail_page_heading-->
	...
	<form name="frm_step4" id="frm_step4" method="post" <?php echo $row['cat_id'] == '4' || $row['cat_id'] == '5' || $row['cat_id'] == '6' ? "action='add_to_cart.php'" : NULL; ?>>
		<?php
		...
		<div class="detrail_page_desc">
			<p>
				<?php if ( $row['cat_id'] != '2' ) : ?>
				<input type='radio' class='rbo_mail_options' name='mail_option' value='with_wed' id="with_wed" <?php echo isset( $mail_option ) && $mail_option == 'with_wed' ? 'checked="checked"' : !isset( $mail_option ) ? 'checked="checked"' : NULL;?>/>
				<label for="with_wed">Deliver these cards with my wedding invitations. (Same shipping method will be used for these cards)</label>
				<br/>
				<?php endif; ?>
				<input type="radio" class="rbo_mail_options" name="mail_option" value="send_me" id="send" <?php echo isset( $mail_option ) && $mail_option == 'send_me' ? 'checked="checked"' : NULL;?> />
				<label for="send">Ship these cards to me (regardless of mailing method I chose for any other cards)</label>
				<?php if ( $row['cat_id'] == '2' ) : ?>
				<br/>
