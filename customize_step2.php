...
<div class="body_internal_wrapper">
	<div class="process_step_wrapp">
		<img src="<?php echo ($row['cat_id'] == '4' || $row['cat_id'] == '5' || $row['cat_id'] == '6' ? siteURL.'images/where_when_1__no-env.png' : siteURL.'images/where_when_1.png');?>" />
	</div>
	<!--detail_page_heading-->
	...
	<form name="frm_step3" id="frm_step3" method="post">
		...
		<div class="detrail_page_desc">
			<p>
				Enter the details you would like to include on your cards. We will use your information to generate an online preview of your personalized design which will be displayed on the next page.<br/>
				<?php if ( $row['cat_id'] != 3 ) { ?>
				<em>Please insert line breaks at the end of each line in your card by hitting the “Enter” key.</em>
				<?php } ?>
			</p>
			<style type="text/css">
		...
		<div class="detrail_page_desc">
			...
			for ($i = 0; $i < $total_fields; $i++ ) {
				...
				<?php
				} else if ( $name_id == 'ET2' || $name_id == 'ET1' ) {
				...
				if ( $name_id != 'D' && $name_id != 'T' && $row['cat_id'] != "3" && $name_id != 'T1' && $name_id != 'TT1' ) {
					$js_validation .= "
					if ( $('#$name_id').val().trim() == '' ) {
