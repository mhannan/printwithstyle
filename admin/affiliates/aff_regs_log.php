...
?>
			...
			<div class="content-box"><!-- Start Content Box --> 
				...
				<div class="content-box-header">
					<h3>Registrations Log</h3>
					<ul class="content-box-tabs">
						<li> <a href="#tab1" class="<?php echo $tab_show_class;?>">Registrations Log </a> </li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					<div class="tab-content <?php echo $tab_show_class;?>" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
							...
							<?php
							 	$rSet = getLatestRegistered_byAffiliatID($_GET['af_id'], $dateFilterSql='');	// filter is being initialized on top of page and bein updated in filter part
