  ...
  <div class="content-box-content" >
   	<table border="0" cellpadding="10" cellspacing="4" width="100%" style="padding:10px !important">
		...
		<tr>
		 ...
		 <tr>
			<td style="padding:10px !important">
				<div style="float:left;margin-top: 16px"><a href="<?php echo siteURL;?>admin/coupon-codes/">&nbsp;Coupon Codes</a></div>
				<div style="clear:both"></div>
            </td>
			<td style="padding:10px !important">
				<div style="float:left;margin-top: 16px"><a href="<?php echo siteURL;?>admin/testimonials/">&nbsp;Testimonials</a></div>
				<div style="clear:both"></div>
			</td>
